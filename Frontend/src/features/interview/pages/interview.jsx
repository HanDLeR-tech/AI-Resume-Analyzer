...
const Interview = () => {
  ...
  const { report, getReportById, loading, getResumePdf } = useInterview(); // Replace with actual data fetching logic
  ...
  <p className="loading-text">AI is generating your interview strategy...</p>
</main>
    );
  }
